...
export default async function handler(request, response) {
  ...
  const apiUrl = `https://api.open-meteo.com/v1/forecast?latitude=${lat}&longitude=${lon}&&daily=temperature_2m_max,temperature_2m_min,precipitation_sum,wind_speed_10m_max&models=gfs_seamless&timezone=Europe%2FBerlin`;
